...
import { setRecoveryPassword } from "@/api/inde";
...
import {
  ...
  selectRecoveryData,
} from "@/store/slices/auth/recoveryPasswordSlice";
...
export const CreateNewPasswordForm = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (data) => {
      if (recoveryPassData.code && recoveryPassData.email) {
        try {
          await setRecoveryPassword({
            code: recoveryPassData.code,
